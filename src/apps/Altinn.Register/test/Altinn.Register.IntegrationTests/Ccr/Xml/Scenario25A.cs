...
/// <summary>
/// Changes the organization form of an existing organization to "FLI"
/// Ignores the R-FV field
/// </summary>
public class Scenario25A
    : CcrXmlUpdateTestBase
{
    ...
    protected override string XmlToApply
        ...
        <batchAjourholdXML xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="batchAjourholdXML_versjon2_1.xsd">
          ...
          <enhet organisasjonsnummer="{{_org.OrganizationIdentifier.Value}}" organisasjonsform="FLI" hovedsakstype="E" undersakstype="EN" foersteOverfoering="N" datoFoedt="20260227" datoSistEndret="20260502">
            <infotype felttype="R-FV" endringstype="N">
              <opplysning>J</opplysning>
            </infotype>
          </enhet>
    ...
    protected override async ValueTask Verify(IUnitOfWork uow, CancellationToken cancellationToken)
    {
        ...
        updatedOrg?.UnitType.Value.ShouldBe("FLI");
    }
}
