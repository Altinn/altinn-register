...
namespace Altinn.Register.Tests.TestingControllers
{
        ...
        : BaseControllerTests(fixture)
    {
        ...
        public async Task GetParty_ValidTokenRequestForExistingParty_ReturnsParty()
        {
            ...
            // Arrange
            _partiesClient.Setup(s => s.GetPartyById(It.Is<int>(o => o == partyId), It.IsAny<CancellationToken>())).ReturnsAsync(new Contracts.V1.Party());
        ...
        public async Task GetParty_ValidUserTokenRequestForNonExistingParty_ReturnsUnauthorized()
        {
            ...
            // Arrange
            _partiesClient.Setup(s => s.GetPartyById(It.Is<int>(o => o == partyId), It.IsAny<CancellationToken>())).ReturnsAsync((Contracts.V1.Party)null);
        ...
        public async Task GetPartyByUuid_FetchParty_ReturnsParty()
        {
            ...
            _partiesClient.Setup(s => s.GetPartyById(It.Is<Guid>(g => g == new Guid("93630d41-ca61-4b5c-b8fb-3346b561f6ff")), It.IsAny<CancellationToken>())).ReturnsAsync(new Contracts.V1.Party());
        ...
        public async Task GetPartyByUuid_UserToken_FetchNullParty_ReturnsNotAuthorized()
        {
            ...
            _partiesClient.Setup(s => s.GetPartyById(It.Is<Guid>(g => g == new Guid("93630d41-ca61-4b5c-b8fb-3346b561f6ff")), It.IsAny<CancellationToken>())).ReturnsAsync((Contracts.V1.Party)null);
